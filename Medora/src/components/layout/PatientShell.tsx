...
import { Bell, LogOut, Menu, Search, ShoppingBag, SlidersHorizontal, User } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[248px] flex-col border-r border-sidebar-border bg-sidebar lg:flex">
        ...
        <div className="border-t border-sidebar-border p-3">
          ...
          >
            <SlidersHorizontal className="size-3.5" aria-hidden /> Switch workspace
          </Link>
        </div>
      </aside>
        ...
        <header className="sticky top-0 z-20 border-b border-border bg-background/85 backdrop-blur">
          <div className="flex h-16 items-center gap-3 px-4 sm:px-6">
            <Sheet open={mobileNav} onOpenChange={setMobileNav}>
              ...
              <SheetContent side="left" className="w-[280px] p-0">
                ...
                <ScrollArea className="h-[calc(100vh-72px)] px-2 py-5">
                  <NavList items={patientNav} onNavigate={() => setMobileNav(false)} />
                </ScrollArea>
              </SheetContent>
            </Sheet>
            ...
            >
              ...
              <span className="truncate">Search medicines, pharmacies, records…</span>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <DropdownMenuLabel className="font-normal">
                    <p className="font-semibold">{profile?.full_name ?? state.profile.fullName}</p>
                  ...
                  <DropdownMenuItem asChild>
                    <Link to="/switch">
                      <SlidersHorizontal className="size-4" aria-hidden /> Switch workspace
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />

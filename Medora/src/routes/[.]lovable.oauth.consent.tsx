    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            This lets {clientName} use Medora's medicine intelligence tools as you.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <ul className="space-y-2 text-muted-foreground">
            <li>Search the medicine catalogue and read product details</li>
            <li>Compare local pharmacy prices and browse the pharmacy directory</li>
          ...
          <p className="text-xs text-muted-foreground">
            This does not bypass Medora's permissions or backend policies. Tool responses are
            informational demo data and never medical advice.
          </p>
          {error ? (
